...
const ForgotPopup = ({ setisEmailPopup, setisForgotPopup, shouldUpdate }) => {
      ...
      {showSuccessMessage ? (
       ...
       <div className='bg-white w-fit font-roboto p-3 rounded-md'>
         ...
         <p className='text-[#20808D] text-center w-[20rem]'>
           Email sent to your account. Please check your email for instructions on resetting your password.
         </p>
         <div className='mt-5 flex justify-center items-center'>
           <button className='p-2 w-[19rem] rounded-md text-white bg-[#20808D] tracking-wider' onClick={handleButtonClick}>
             Back to Sign in
           </button>
         </div>
       </div>
      ...
      <div style={{ height: '100vh', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        ...
        <div className=' bg-white w-fit font-roboto p-3 rounded-md'>
          ...
          <div className='flex justify-center items-center mb-2'>
            <button onClick={handleResetPassword} className='p-2 w-[19rem] rounded-md text-white bg-[#20808D] tracking-wider'>Continue</button>
          </div>

          <div className='flex justify-center items-center'>
            <span className='text-[#20808D] cursor-pointer' onClick={handleButtonClick}>Back to Sign in</span>
          </div>
