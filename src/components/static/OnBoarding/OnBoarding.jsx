  ...
  return (
    <>
      <div className="md:flex block items-center font-roboto w-screen h-screen">
        {/* LEFT SIDE  */}
        <div
          style={{ backgroundColor: onBoardingData[onBoardingIndex].color }}
          className={`flex-1 md:relative w-[100%] h-[100%] flex justify-center items-start flex-col p-4`}
        >
          {/* MAIN TITLE IF PRESENT  */}
          {onBoardingData[onBoardingIndex].mainHeading && (
            <div className="mb-3">
              <h1
                style={{ color: onBoardingData[onBoardingIndex].contentColor }}
                className="text-2xl onboarding-slide-enter"
              >
                {onBoardingData[onBoardingIndex].mainHeading}
              </h1>
            </div>
          ...
          <div className="flex gap-3 items-center" key={currentData.subHeading}>
            <p
              ...
              className="text-xl"
            >
              {onBoardingData[onBoardingIndex].subHeading}
            </p>
            <div
              style={{
                backgroundColor: onBoardingData[onBoardingIndex].contentColor,
              }}
              className="w-[4rem] h-[4rem] onboarding-slide-enter  rounded-full"
            ></div>
          </div>
          ...
          <div className="md:absolute bottom-10 mt-5">
            <p
              style={{ color: onBoardingData[onBoardingIndex].contentColor }}
              className="w-[80%] onboarding-slide-enter"
            >
          ...
          <div className="block md:hidden mt-4 w-[100%]">
            ...
            <div className="flex justify-center items-center">
              <button
                onClick={() => nav("/login-route")}
                style={{ border: "2px solid #20808D " }}
