        ...
        <div className='relative'>
            ...
            <div className='flex justify-between h-[100vh] overflow-y-auto overflow-x-hidden font-roboto'>
                ...
                <div className='flex-1 relative'>
                    ...
                    <div className='flex gap-3 cursor-pointer p-3 h-fit' onClick={() => nav("/pdf/organize")}>
                ...
                <div className='w-[13rem] hidden  shadow-CardShadow md:flex justify-start items-center flex-col pt-4 pb-4 relative'>
                    ...
                    <div className='w-[100%] pr-2 pl-2 mt-4'>
                        ...
                        <div className='flex justify-between gap-x-2 items-center'>
                            ...
                            <div className='w-[50%]'>
                                ...
                                <div style={{ border: "1px solid black" }} className='w-[100%] cursor-pointer h-[2.5rem] rounded-[0.375rem] flex gap-3 items-center pl-1 pr-1'>
                    ...
                    <div className=' absolute bottom-3 flex justify-center items-center'>
                        <button className='bg-[#20808D] text-white w-[10rem] h-[2.5rem] rounded-md'>Organize</button>
                    </div>
