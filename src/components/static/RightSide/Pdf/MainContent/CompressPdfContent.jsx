                ...
                <div className='w-[14rem] hidden  shadow-CardShadow md:flex justify-start items-center flex-col pt-4 pb-4 relative'>
                    ...
                    <div className=''>
                        ...
                        <div>
                            ...
                            <p className='mt-2 text-sm pl-2 pr-2'>Less quality, high compression</p>
                            <div className='bg-[#D9D9D9] w-[13rem] h-[1px] mt-2 mb-4'></div>
                        </div>


                        <div>
                            <p className='text-[#20808D] pl-2 pr-2'>Recommended Compression</p>
                            <p className='mt-2 text-sm pl-2 pr-2'>Good quality, good compression</p>
                            <div className='bg-[#D9D9D9] w-[13rem] h-[1px] mt-2 mb-4'></div>
                        </div>

                        <div>
                            <p className='text-[#20808D] pl-2 pr-2'>Less compression</p>
                            <p className='mt-2 text-sm pl-2 pr-2'>High quality, less compression</p>
                            <div className='bg-[#D9D9D9] w-[13rem] h-[1px] mt-2 mb-2'></div>
                        </div>
