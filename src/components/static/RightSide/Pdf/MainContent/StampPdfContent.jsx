        ...
        <div className='relative'>
            ...
            <div className='flex justify-between h-[100vh] overflow-y-auto overflow-x-hidden font-roboto'>
                ...
                <div className='flex-1 relative'>
                    ...
                    <div className='flex gap-3 cursor-pointer p-3 h-fit' onClick={() => nav("/pdf/stamp")}>
                ...
                <div className='w-[13rem] hidden  shadow-CardShadow md:flex justify-start items-center flex-col pt-4 pb-4 relative'>
                    ...
                    <div className='w-[100%] pr-2 pl-2 mt-4'>
                        ...
                        <input style={{ border: "1px solid black" }} type="text" name="" placeholder='Enter Text' className='w-[100%] h-[2.4rem] outline-none pl-3 pr-3 rounded-[0.375rem]' />
                    </div>

                    <div className=' absolute bottom-3 flex justify-center items-center'>
                        <button className='bg-[#20808D] text-white w-[10rem] h-[2.5rem] rounded-md'>Stamp Pdf</button>
                    </div>
