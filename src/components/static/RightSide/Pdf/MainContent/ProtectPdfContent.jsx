        ...
        <div className='relative'>
            ...
            <div className='flex justify-between h-[100vh] overflow-y-auto overflow-x-hidden font-roboto'>
                ...
                <div className='flex-1 relative'>
                    ...
                    <div className='flex gap-3 cursor-pointer p-3 h-fit' onClick={() => nav("/pdf/protect")}>
                ...
                <div className='w-[13rem] hidden  shadow-CardShadow md:flex justify-start items-center flex-col p-4 relative'>
                    ...
                    <div className='flex justify-center items-center flex-col'>
                        ...
                        <p className='text-[#47474f] mt-2 text-sm text-center'>Set a password to protect your PDF file</p>
                    </div>

                    <div className='mt-5'>
                        <input style={{ border: "1px solid rgba(48, 48, 48, 0.50)" }} type="text" placeholder='password' className='w-[100%] h-[2.3rem] rounded-md pl-3 pr-3 text-[#303030] outline-none' />
                        <input style={{ border: "1px solid rgba(48, 48, 48, 0.50)" }} type="text" placeholder='Re-enter password' className='w-[100%] h-[2.3rem] rounded-md pl-3 pr-3 text-[#303030] outline-none mt-4' />
                    </div>

                    <div className=' absolute bottom-3 flex justify-center items-center'>
                        <button className='bg-[#20808D] text-white w-[10rem] h-[2.5rem] rounded-md'>Protect Pdf</button>
                    </div>
