                ...
                !lastStep ?
                    <div className='flex justify-between h-[95%] overflow-y-auto overflow-x-hidden font-roboto'>
                        ...
                        <div className='flex-1 relative'>
                            ...
                            <div className='flex mt-10 justify-center items-center gap-2 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]'>
                        ...
                        <div className='w-[14rem] hidden  shadow-CardShadow md:flex justify-start items-center flex-col pt-4 pb-4 relative'>
                            ...
                            <div className='flex justify-center items-center flex-col'>
                                ...
                                <p className='text-[#47474F] text-sm mt-2 mb-2 pl-2 pr-2 text-center'>Please select more than 1 PDF file</p>
                            </div>
...

                        {
                            ...
                            showLeftSideBar && (
                                ...
                                <div className='w-[14rem] h-[100vh] bg-white md:hidden shadow-CardShadow absolute top-0 right-0 p-4 flex justify-start items-center flex-col'>
                                    ...
                                    <div className='flex justify-center items-center flex-col'>
                                        <p className='text-lg text-center pl-4 pr-4'>Merge PDF</p>
                                        <p className='text-[#D9D9D9] mt-2 mb-2'>Please select more PDF file</p>
                                    </div>
                    ...
                    <div>
                        ...
                        <div className=' flex justify-center items-center flex-col font-roboto mt-10'>
                            <h1 className='text-[#303030] text-lg mb-3 text-center'>PDFs have been merged!</h1>
                            <p className='text-[#474747] text-sm mb-3 text-center'>Click on download button to download merged pdf or continue to work on the file with different tools displayed below.</p>
                            <div className='flex items-center gap-4'>
                                <div onClick={() => setlastStep(false)} className='w-[2rem] cursor-pointer h-[2rem] bg-[#303030] rounded-sm flex justify-center items-center shadow-CardShadow'>
                                    <FaArrowLeftLong className='text-white' />
                                </div>
                                <button className='bg-[#20808D] text-white p-2 rounded-md w-[13rem]'>Download to device</button>
                            ...
                            <div className='flex items-center gap-4 mt-4'>
                                <div style={{ border: "1px solid #D9D9D9" }} className='p-1 rounded-md'>
