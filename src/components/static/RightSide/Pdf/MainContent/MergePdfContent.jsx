    ...
    <>
      {isButtonClicked && mergedFileUrl ? (
        ...
        <div className="relative h-[100vh] ">
          ...
          {!lastStep ? (
            <div className="flex justify-between h-[95%]   font-roboto">
              <div className="flex-1 relative">
                ...
                <div className="absolute right-2">
                  ...
                  >
                    ...
                    />
                    <div className="tooltip bg-[#106e75] text-white  font-bold p-1 rounded-md absolute right-[3rem] max-w-[20rem] whitespace-nowrap overflow-ellipsis">
                      Add more files
                    </div>
                  </label>
                ...
                <div className="flex  justify-center flex-wrap h-full items-center gap-2 ">
                  {[...location.state.pdf, ...selectedFiles].map(
                    (file, index) => {
                      return (
                        <div
                          key={index}
                          className="w-[15rem] rounded-[0.5rem] bg-gray-100"
                        >
