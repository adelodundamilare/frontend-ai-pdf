...
const Routers = () => {
  return (
    ...
    <Routes>
      ...
      <Route path='/pdf/compress/content' element={<CompressPdfContentScreen/>}/>

      <Route path='/pdf/organize' element={<OrganizePdfScreen/>}/>
      <Route path='/pdf/organize/content' element={<OrganizePdfContentScreen/>}/>
      ...
      <Route path='/pdf/protect/content' element={<ProtectPdfContentScreen/>}/>
